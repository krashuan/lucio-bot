...
“instruction”: “Observa lentamente cada dedo. En sueños, las manos suelen tener dedos extra o que cambian al mirarlos fijamente.”
},
{
“tag”: “◯ Pregunta existencial”,
“question”: “¿Estás soñando ahora mismo?”,
“instruction”: “Detente. ¿Cómo llegaste aquí? ¿Recuerdas los últimos 5 minutos con claridad?”
},
{
“tag”: “Aa Texto cambiante”,
“question”: “Lee algo, cierra los ojos y vuelve a leerlo.”,
“instruction”: “Busca un texto cercano. Léelo, aparta la mirada, vuélvelo a leer. En sueños el texto cambia.”
},
{
“tag”: “∿ Tapón nasal”,
“question”: “Tápate la nariz. ¿Puedes respirar?”,
“instruction”: “Cierra la boca y tápate la nariz. Intenta inhalar. En sueños puedes respirar igual.”
},
{
“tag”: “◌ Memoria reciente”,
“question”: “¿Qué hacías hace 10 minutos?”,
“instruction”: “Intenta recordar con detalle. En los sueños, la memoria reciente es vaga o imposible.”
},
]
...
“Pregúntate: ¿estoy soñando? Hazlo suficientes veces despierto y lo harás dormido. — Técnica DILD”,
“El sueño lúcido es la habilidad de despertar dentro del sueño sin salir de él. — Stephen LaBerge”,
“La frontera entre el sueño y la vigilia es más delgada de lo que imaginas. — Frederik van Eeden”,
...
f"{'WBTB activado: ' + user['wbtb_start'] + ' – ' + user['wbtb_end'] if user['wbtb_enabled'] else ''}\n\n"
...
await update.message.reply_text(f”✨ *{random_frase()}*”, parse_mode=“Markdown”)
...
await bot.send_message(chat_id=chat_id, text=msg, parse_mode=“Markdown”, reply_markup=markup)
